...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <p class="intro">
                Halo Admin,<br><br>
                Ada <strong>pendaftaran B2B baru</strong> yang membutuhkan review dan persetujuan Anda. Berikut detail
                pendaftar:
            </p>
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <span
                        class="info-value">{{ $applicant->created_at->setTimezone('Asia/Jakarta')->format('d M Y, H:i') }}
                        WIB</span>
                </div>
                <div class="info-row">
            ...
            <div class="note">
                💡 Login ke dashboard admin, buka menu <strong>User Management</strong>, filter tab <strong>B2B
                    Partner</strong>, lalu temukan akun atas nama <strong>{{ $applicant->name }}</strong> untuk
                menyetujui atau menolak pendaftaran ini.
            </div>
        </div>
